            ...
            try { list.innerHTML = logEntries.map((e, idx) => {
              ...
              <div class="log-item-top" onclick="toggleLogItem(${idx})">
                ...
                <div class="log-right">
                  ...
                  <div class="log-gap-lbl" style="font-size:8px">${e.overallClear ? "Ft Over Clr" : "Ft to Contact"}</div>
                </div>
              ...
              <div class="log-detail">
                <div class="log-detail-grid">
                  ...
                  <div class="log-detail-cell"><div class="log-detail-lbl">${e.overallClear ? "Ft Over Req'd Clr" : "Ft to Contact"}</div><div class="log-detail-val" style="color:${e.overallClear ? 'var(--success)' : 'var(--danger)'}">${(e.worstMargin >= 0 ? '+' : '') + e.worstMargin.toFixed(1)}<span style="font-size:10px;color:var(--muted)">ft</span></div></div>
                </div>
